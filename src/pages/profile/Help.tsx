...
//   >
//     <path
//       d="M13.172 12.0003L8.22205 16.9503L9.63605 18.3643L16 12.0003L9.63605 5.63626L8.22205 7.05026L13.172 12.0003Z"
//       fill="white"
//       fillOpacity="0.4"
//     />
//   </svg>
...
const Help = () => {
  ...
  return (
    <h1></h1>
    // <div className="h-full min-h-screen bg-darkbg">
    //   <Link
    //     to={"/profile"}
    //     className="w-[50px] top-[15px] left-[20px] z-[999] absolute focus:outline-none bg-darkbg focus:bg-darkbg"
    //   >
    //     {LeftIcon}
    //   </Link>

    //   {/* customer service */}
    //   <div className=" hidden absolute right-[20px] bottom-[150px]">
    //     <div className="">
    //       <svg
    //         width="65"
    //         height="65"
    ...
    //         <p className="text-white text-opacity-60 text-sm font-normal">
    //           {i?.name ?? ""}
    //         </p>
    //       </div>
    //       {(i?.articles ?? []).map((sub: any) => (
    //         <button
    //           onClick={() => {
    //             navigate(`/helpdetail/${sub.id}`);
    //           }}
    //           className="py-4 mx-4  text-white text-base text-opacity-90 border-b border-b-white/5 flex justify-between"
    //         >
    //           <div className="flex gap-2 items-center ">
    //             <span className="w-1 h-3 bg-red-brand rounded"></span>
    //             {sub.title}
    //           </div>
    //           {RightIcon}
    //         </button>
    ...
    //   <div className="jf-foot bg-neutral-800 bg-opacity-90 py-2 px-4 pb-[30px]">
    //     <button
    //       className="bg-red-brand text-sm px-6 py-3 text-white font-medium rounded w-full "
